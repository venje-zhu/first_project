...
if __name__ == "__main__":
    ...
    for epoch in range(1, opt.niter+1):
        ...
        real_img = transform_tns(Image.open(os.path.join('input', 'real01.jpg'))).unsqueeze(0)[:,:,:,0:256]
        real_mask = transform_tns(Image.open(os.path.join('input', 'real01.jpg'))).unsqueeze(0)[:,:,:,256:512]
